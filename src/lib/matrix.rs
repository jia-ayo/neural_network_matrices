...
impl Matrix {
    ...
    pub fn add(&mut self, other: &Matrix) -> Matrix {
        if self.rows != other.rows || self.cols != other.cols {
            panic!("attempting to add matrix of incorrect dimension");
        }
    ...
    pub fn dot_multiply(&mut self, other: &Matrix) -> Matrix {
        if self.rows != other.rows || self.cols != other.cols {
            panic!("attempting to dot multiply matrix of incorrect dimension");
        }
    ...
    pub fn subtract(&mut self, other: &Matrix) -> Matrix {
        if self.rows != other.rows || self.cols != other.cols {
            panic!("attempting to subtract matrix of incorrect dimension");
        }
